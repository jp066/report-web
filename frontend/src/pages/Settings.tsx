                  ...
                  {editField === "nome" ? (
                    ...
                    <>
                      <span className="flex-1">
                        {user.nome || (
                          <span className="text-gray-200">(não informado)</span>
                        )}
                      </span>
                      <FiEdit
            ...
            <section id="preferencias" className="space-y-4">
              ...
              <div>
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400 ml-1">
                  ...
                  autorizados. Somente disponível se você já configurou um autenticador.
                </span>
              </div>
              ...
              <div>
                ...
                />
                <span className="text-xs text-gray-500 dark:text-gray-400 ml-1">
                  Divide relatórios grandes em partes menores automaticamente, aumentando o tamanho dos chunks conforme necessário para otimizar o download e evitar travamentos.
                  Quando ativado, o sistema ajusta o tamanho dos chunks
                  automaticamente para melhorar a performance do download de
                  relatórios extensos.
                </span>
              </div>
            </section>
